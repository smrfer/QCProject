...
header_list = ["RunID","InstrumentID","RunDate","NumberOfCyclesR1","NumberofCyclesR2","FlowCellInDate?",
               ...
               "SlopeOfLineOfBestFitRead1ExceedsThreshold?","SlopeOfLineOfBestFitRead2","ThresholdSlopeR2","SlopeOfLineOfBestFitRead2ExceedsThreshold?","ProportionOfUndeterminedReads?",
...
for run in file_of_runs:
    ...
    polynomial_order = 5
    std_threshold_set = 2
    threshold_slope_r1 = read_means.returnThresholdVals(start_x,stop_x,"r1",polynomial_order,std_threshold_set,read1_length)
    ...
    if r2_start < (len(qual_metrics_arr_mod_int_sorted)):
        ...
        threshold_slope_r2 = read_means.returnThresholdVals(start_x,stop_x,"r2",polynomial_order,std_threshold_set,read2_length)

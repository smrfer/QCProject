...
outcsv = outpath + "\\BegAndEndR1.csv" #"\\DeleteMe.csv"
...
for run in file_of_runs:
    ...
    data_for_run.append(optimal_vals_Q30_r1_1[0])
    data_for_run.append(optimal_vals_Q30_r1_2[0])
    
    if abs(optimal_vals_Q30_r1_1[0]) > abs(threshold_slope_r1):
        data_for_run.append("yes")
    else:
        data_for_run.append("no")
    
    if abs(optimal_vals_Q30_r1_2[0]) > abs(threshold_slope_r1):
        data_for_run.append("yes")
    else:
        data_for_run.append("no")
